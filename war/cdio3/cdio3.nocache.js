...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cdio3" because\n';
 ...
 * "/cdio3.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cdio3'].superdevmode = true;

  var expectedSuffix = '/cdio3.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cdio3 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cdio3';
  var devModeSessionKey = '__gwtDevModeSession:cdio3';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cdio3/cdio3.nocache.js';
  ...
  $wnd.__gwt_activeModules['cdio3'].canRedirect = true;
  $wnd.__gwt_activeModules['cdio3'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cdio3?user.agent=' + ua + '&_callback=' + callback;
